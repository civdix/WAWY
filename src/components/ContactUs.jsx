  ...
  return (
    <div className="ContactUs">
      ...
      <div className="imagePanditJi ">
        <img
          src={require("../Assests/images/PanditjiCalling.png")}
          alt="PanditJiCallingImage"
          className="w-50 imgPanditJi"
        />
      </div>
      <div className="contactUsForm glassy w-50 my-2 mx-4">
        ...
        <div className="Message">
          <legend className="text-white">Message</legend>
          <textarea
            name="message"
            id="message"
            rows={4}
